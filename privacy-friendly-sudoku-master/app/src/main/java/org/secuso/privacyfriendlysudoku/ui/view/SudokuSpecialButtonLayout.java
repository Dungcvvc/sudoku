...
public class SudokuSpecialButtonLayout extends LinearLayout implements IHighlightChangedListener {
    ...
    GameController gameControllerFree;
    private final String TAG = "Sudo";
    ...
    private void opendialog() {
        ...
        Button btnUser = dialog.findViewById(R.id.btnUse);
    ...
    private void showVid() {
        if (mRewardedAd != null) {
            ...
            loadRewardedAd();
            //Toast.makeText(TAG, "No vid", Toast.LENGTH_SHORT).show();
        }
    }
